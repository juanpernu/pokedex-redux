...
export const Loading = () => (
  <div className="flex flex-col absolute justify-center items-center bg-white/[.70] w-full h-screen z-[1000] translate-x-1/2 translate-y-1/2 -left-1/2 -top-1/2">
    <svg
    ...
    <p className="m-0 text-black">Un momento, por favor...</p>
  </div>
);
